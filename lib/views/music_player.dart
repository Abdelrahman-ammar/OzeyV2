...
void initState() {
  ...
  void loadSong(Music music) async {
    ...
    final credentials = SpotifyApiCredentials('e9eb2816d1944d4d82a595c4d0380b17', '405cb15f21a0431ca584f94a8de45e47');
    ...
    spotify.tracks.get(music.trackId).then((track) async {
      ...
      if (tempSongName != null) {
        ...
        music.duration = video.duration;
          setState(() {
    isLoading = false; // Set loading state to false when song information is loaded
       });
          ...
          children: [
            ...
            Expanded(
              ...
              child: isLoading
                  ...
                  : Center(child: ArtWorkImage(image: currentSong!.songImage)),
            ),
            Expanded(
              child: Column(
                children: [
